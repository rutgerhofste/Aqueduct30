...
PRINT_METADATA = True
OUTPUTPATH = os.path.join('K:/',r'PCRGlob2WBBigV02\soilMoisture')
#</editor-fold>
...
for oneFile in files:
    ...
    print "Time Minimum: ", min(timeNormal), " Days since 1900-01-01:", min(time)
    print "Time Maximum: ", max(timeNormal), " Days since 1900-01-01:", max(time)
